package ru.practicum.utils.log;
...
public class LogInputOutputAspect {
    ...
    @Before("@annotation(ru.practicum.utils.log.LogInputOutputAnnotaion)")
    ...
    @AfterReturning(
        pointcut = "@annotation(ru.practicum.utils.log.LogInputOutputAnnotaion)",
